...
Route::group(['prefix'=>'giagocvlxd'],function (){
    Route::get('danhsach','GiaGocVlXdController@index');

    Route::get('new','ThGiaGocVlXdController@create');
    Route::get('modify','ThGiaGocVlXdController@edit');
    Route::post('modify','ThGiaGocVlXdController@store');
    Route::post('tonghop\delete','ThGiaGocVlXdController@destroy');
    Route::get('dinhkem','ThGiaGocVlXdController@show');
    Route::get('tonghop','ThGiaGocVlXdController@index');

    Route::post('tralai','ThGiaGocVlXdController@tralai');
    Route::post('congbo','ThGiaGocVlXdController@congbo');
    //
