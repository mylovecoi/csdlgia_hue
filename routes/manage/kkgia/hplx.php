...
Route::get('/giahplxct/deletett','manage\kekhaigia\kkhplx\KkGiaHpLxCtController@delete');
...
Route::get('timkiemkkgiahplx/printf','manage\kekhaigia\kkhplx\KkGiaHpLxXdController@printf');
