...
@section('content')
    ...
    <div class="note note-success">
        ...
        <p>Tài khoản đang sao chép: Tên tài khoản: {{$model->name}}</p>
    </div>
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'taikhoan/copy', 'id' => 'create_tttaikhoan', 'class'=>'horizontal-form', 'method'=>'POST']) !!}
                    ...
                    <input type="hidden" name="username_goc" value="{{$model->username}}">
                    <!-- END FORM-->
                </div>
