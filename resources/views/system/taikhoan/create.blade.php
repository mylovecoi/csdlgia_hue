        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'taikhoan/store', 'id' => 'create_tttaikhoan', 'class'=>'horizontal-form']) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('/taikhoan/danhsach?madv='.$inputs['madv'])}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
