...
@section('content')
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        ...
                        <button type="button" onclick="add()" class="btn btn-default btn-xs" data-target="#modify-modal"
                            data-toggle="modal">
                        ...
                        <tbody>
                            ...
                            @foreach ($model as $key => $tt)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">{{ $tt->capdo }}</td>
                                    <td>
                                        {{-- @if (chkPer('hethong', 'hethong_pq', 'danhmucdvt', 'danhmuc', 'modify')) --}}
                                        <button type="button"
                                            onclick="edit('{{ $tt->madiaban }}','{{ $tt->tendiaban }}','{{ $tt->capdo }}','{{ $tt->madiaban_goc }}')"
    ...
    {!! Form::open(['url' => '/tinhuyenxa/update', 'id' => 'frm_modify']) !!}
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::text('madiaban', null, ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <label class="control-label">Tên địa bàn hành chính<span class="require">*</span></label>
                                {!! Form::text('tendiaban', null, ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <label class="control-label">Cấp địa bàn hành chính<span class="require">*</span></label>
                                {!! Form::select('capdo', ['T' => 'Tỉnh', 'H' => 'Huyện', 'X' => 'Xã'], null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <label class="control-label">Địa bàn hành chính cấp trên<span
                                        class="require">*</span></label>
                                {!! Form::select('madiaban_goc', $a_capql, null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/tinhuyenxa/delete', 'id' => 'frm_delete']) !!}
