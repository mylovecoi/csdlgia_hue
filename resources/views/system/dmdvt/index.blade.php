                        ...
                        <tbody>
                            ...
                            @foreach($model as $key=>$tt)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        @if(chkPer('hethong', 'hethong_pq', 'danhmucdvt','danhmuc', 'modify'))
                                            <button type="button" onclick="edit('{{$tt->madvt}}','{{$tt->dvt}}')" class="btn btn-default btn-xs mbs" data-target="#modify-modal" data-toggle="modal">
                        ...
                        <div class="form-horizontal">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    {!!Form::text('madvt', null, array('id' => 'madvt','class' => 'form-control'))!!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
