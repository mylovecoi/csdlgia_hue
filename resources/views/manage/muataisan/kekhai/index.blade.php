...
@section('content')
    <h3 class="page-title">
        Thông tin hồ sơ trúng thầu của hàng hóa, dịch vụ được mua sắm theo quy định của pháp luật về đấu thầu
    </h3>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(chkPer('csdlmucgiahhdv','taisan', 'muataisan', 'hoso', 'modify'))
                ...
                <div class="portlet-body form-horizontal">
                    ...
                    <table id="sample_4" class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Thông tin</br>quyết định</th>
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td style="text-align: center">{{$tt->soqd}}</br>{{getDayVn($tt->thoidiem)}}</td>
                                <td style="text-align: left">{{$tt->thongtinqd}}</td>
                                <td>{{$tt->tennhathau}}</td>
                                @include('manage.include.form.td_trangthai')
                                <td style="text-align: left">{{$a_donvi_th[$tt->macqcq]?? ''}}</td>
                                <td>
                                    @if(chkPer('csdlmucgiahhdv','taisan', 'muataisan','hoso','modify') && in_array($tt->trangthai,['CHT', 'HHT']))
                                    ...
                                    @endif
                                    @if(chkPer('csdlmucgiahhdv','taisan', 'muataisan', 'hoso', 'approve')&& in_array($tt->trangthai,['CHT', 'HHT']))
