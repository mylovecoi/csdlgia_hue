...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin mặt hàng {{$modelmh->tenmh}} sách<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'giasach/'. $model->id, 'class'=>'horizontal-form','id'=>'update_binhongia']) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('giasach?&mamh='.$model->mamh.'&trangthai='.$model->trangthai)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Thêm mới thông tin sách</h4>
                </div>
