        ...
        function ClickEdit(maso) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var form = $('#frm_create');
                    form.find("[name='masodanhmuc']").val(data.masodanhmuc);
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('noidung', null, ['id' => 'noidung', 'class' => 'form-control', 'required', 'rows' => 3]) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::input('date', 'tungay', null, ['id' => 'tungay', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Ngày kết thúc<span class="require">*</span></label>
                                {!! Form::input('date', 'denngay', null, ['id' => 'denngay', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
