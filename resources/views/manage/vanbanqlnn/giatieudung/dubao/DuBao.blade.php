                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_4">
                        ...
                        <tr>
                            ...
                            <th rowspan="2" style="text-align: center">Chỉ số CPI</th>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{$tt_I->dvt}}</td>
                            <td class="text-right">{{$tt_I->ketqua}}</td>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>{{$tt_II->dvt}}</td>
                                <td class="text-right">{{$tt_II->ketqua}}</td>
                                <td class="text-center">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{$tt_III->dvt}}</td>
                                    <td class="text-right">{{$tt_III->ketqua}}</td>
                                    <td class="text-center">
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{$tt_IV->dvt}}</td>
                                        <td class="text-right">{{$tt_IV->ketqua}}</td>
                                        <td class="text-center">
