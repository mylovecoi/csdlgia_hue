        ...
        <div class="col-md-12">
            ...
            <div class="portlet box wi">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('giagiay/create?madv='.$inputs['madv'].'&manghe='.'GIAY')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-plus"></i>&nbsp;Thêm mới</a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_4">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('giagiay/xemhoso?mahs='.$tt->mahs)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                    @if(in_array($tt->trangthai,['CC','TL']))
                                        <a href="{{url('giagiay/modify?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
