...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin mặt hàng {{$modelmh->tenmh}} giấy<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'giayin/'. $model->id, 'class'=>'horizontal-form','id'=>'update_binhongia']) !!}
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="sample_3">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center">Tên giấy</th>
            ...
            <div style="text-align: center">
                <a href="{{url('giayin?&mamh='.$model->mamh.'&trangthai='.$model->trangthai)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Thêm mới thông tin than</h4>
                </div>
    ...
    <div class="modal fade bs-modal-lg" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Thêm mới thông tin giấy</h4>
                </div>
