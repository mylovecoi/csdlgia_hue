...
{{--                            <td>{{$tt->ghichu}}</td>--}}
                            ...
                            <td>
                                <a href="{{url('binhongia/xemhoso?mahs='.$tt->mahs)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>

                                @if(in_array($tt->trangthai,['CC','TL']) && chkPer('csdlmucgiahhdv','bog', 'bog', 'hoso', 'modify'))
                                    <a href="{{url('binhongia/modify?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
