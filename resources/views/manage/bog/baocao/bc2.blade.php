...
<p style="text-align: center; font-weight: bold; font-size: 16px;text-transform: uppercase;">BÁO CÁO CHI TIẾT KÊ KHAI, ĐĂNG KÝ GIÁ MẶT HÀNG BÌNH ỔN GIÁ</p>
        ...
        @foreach($model as $key=>$tt)
            <tr>
                ...
                <td class="active" colspan="5">{{$a_com[$tt->madv] ?? ''}}
                    ...
                    -<b>Mã hồ sơ:</b> <a href="{{ url('binhongia/xemhoso?mahs=' . $tt->mahs) }}">
                        {{$tt->mahs}}
                    </a>
                . Số công văn :{{$tt->socv}} -
