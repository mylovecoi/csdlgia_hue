...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin mặt hàng {{$modelmh->tenmh}} than<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'giathan/'. $model->id, 'class'=>'horizontal-form','id'=>'update_binhongia']) !!}
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="sample_3">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center">Tên than</th>
            ...
            <div style="text-align: center">
                <a href="{{url('giathan?&mamh='.$model->mamh.'&trangthai='.$model->trangthai)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
