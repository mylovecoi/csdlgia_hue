                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_3">
                                    ...
                                    @foreach($model_ct as $key=>$tt)
                                        <tr>
                                            ...
                                            <td>{{$tt->ghichu}}</td>
                                            <td>
                                                <button type="button" onclick="editthan({{$tt->id}});" data-target="#modal-create" data-toggle="modal" class="btn btn-default btn-xs mbs">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="createthan()">Hoàn thành</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" data-dismiss="modal" class="btn btn-default">Thoát</button>
                    <button type="button" class="btn btn-primary" onclick="delthan()">Đồng ý</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
