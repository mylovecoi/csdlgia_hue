...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiadvcahue?&madv='+$('#madv').val()+'&nam='+nam ;
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('kekhaigiadvcahue/create?&madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(canEdit($tt->trangthai))
                                        <a href="{{url('kekhaigiadvcahue/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
