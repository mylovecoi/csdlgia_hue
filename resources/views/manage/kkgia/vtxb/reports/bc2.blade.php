...
<p style="text-align: center; font-weight: bold; font-size: 16px;text-transform: uppercase;">BÁO CÁO KÊ KHAI Cước vận tải hành khách bằng xe buýt tuyến cố định</p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="active" colspan="8">{{$tt->tendn}}
                ...
                -<b>Mã hồ sơ:</b> <a href="{{ url('kekhaivantaixebuyt/prints?mahs=' . $tt->mahs) }}">
                    {{$tt->mahs}}
                </a>
                . Số công văn :{{$tt->socv}} -
