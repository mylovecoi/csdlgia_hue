    ...
    <script>
        ...
        $(function() {
            $('#nam').change(function() {
                ...
                var url = '/xetduyetkekhaigiavtxb?' + namhs + madv + '&trangthai=' + $('#trangthai').val();
        ...
        function confirmHuyduyet(mahs) {
            ...
            $.ajax({
                url: '/xetduyetkekhaigiavtxb/tthuyduyet',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
...
@section('content')
    ...
    <div class="row">
                            ...
                            <tbody>
                                @foreach ($model as $key => $tt)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('kekhaivantaixebuyt/prints?&mahs=' . $tt->mahs) }}"
        ...
        <div class="modal fade" id="nhanhsedit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url' => 'xetduyetkekhaigiavtxb/nhanhsedit', 'id' => 'frm_nhanhsedit']) !!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        ...
        <div class="modal fade" id="huyduyet-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url' => 'xetduyetkekhaigiavtxb/huyduyet', 'id' => 'frm_huyduyet']) !!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
