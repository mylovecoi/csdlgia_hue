...
@section('content')
    ...
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'post', 'url'=>'kekhaivantaixebuyt/store', 'class'=>'horizontal-form','id'=>'update_kkvtxb']) !!}
        ...
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('kekhaivantaixebuyt?&madv='.$model->madv)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_kkvtxb").validate({
                rules: {
                    ten :"required"
                },
                messages: {
