        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    ...
                    {!! Form::model($model, [
                        'method' => 'post',
                        'url' => 'doanhnghiep/store',
                        'class' => 'horizontal-form',
                        'id' => 'update_tttaikhoan',
                        'files' => true,
                    ]) !!}
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('tendn', null, ['id' => 'tendn', 'class' => 'form-control required', 'autofocus']) !!}
                                    @if ($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('madv', null, ['id' => 'madv', 'class' => 'form-control required', 'disabled']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('chucdanh', null, ['id' => 'chucdanh', 'class' => 'form-control required']) !!}
                                    @if ($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('nguoiky', null, ['id' => 'nguoiky', 'class' => 'form-control required']) !!}
                                    @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Giấy đăng ký kinh doanh</label>
                                    <a href="{{ url('data/doanhnghiep/' . $model->tailieu) }}"
                                        target="_blank">{{ $model->giayphepkd }}</a>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="button" data-target="#modal-create" data-toggle="modal"
                                        class="btn btn-success btn-xs"><i class="fa fa-plus"></i>&nbsp;Thêm mới thông tin
                                        lĩnh vực kinh doanh</button>
                                    &nbsp;
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody id="ttts">
                                        @foreach ($modellvcc as $key => $lvcc)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" onclick="getid({{ $lvcc->id }});"
            ...
            <div class="row" style="text-align: center">
                <div class="col-md-12">
                    <a href="{{ url('/doanhnghiep/danhsach') }}" class="btn btn-danger"><i
