    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" data-dismiss="modal" class="btn btn-success" onclick="ClickBC1('/baocaokkgiatacn/bc1')">BC Tổng hợp</button>
                <button type="submit" data-dismiss="modal" class="btn btn-success" onclick="ClickBC2('/baocaokkgiatacn/bc2')">BC chi tiét</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
