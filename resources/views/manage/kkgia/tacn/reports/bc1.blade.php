...
@section('content')
    ...
    <p style="text-align: center; font-weight: bold; font-size: 16px;text-transform: uppercase;">BÁO CÁO KÊ KHAI Giá Thức ăn chăn nuôi</p>
        ...
        @foreach($model as $key=>$tt)
            <tr>
                ...
                <!-- <td class="active">{{$tt->tendn}}
                    ...
                    <br><b>Mã số thuế:</b> {{$tt->madv}}
                    <br><b>Mã hồ sơ:</b> 
                    <a href="{{ url('kekhaigiatacn/prints?mahs=' . $tt->mahs) }}">
                        {{$tt->mahs}}
                    </a>
