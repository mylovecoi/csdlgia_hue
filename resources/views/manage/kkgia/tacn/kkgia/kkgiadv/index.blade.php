...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiatacn?&madv='+$('#madv').val()+'&nam='+nam ;
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('kekhaigiatacn/create?&madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            <i class="fa fa-plus"></i> Kê khai mới </a>

                        <a href="{{url('kekhaigiatacn/nhanexcel?madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(canEdit($tt->trangthai))
                                        <a href="{{url('kekhaigiatacn/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
