...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                var namhs = $('#nam').val();
                var url = '/timkiemgiatacn?'+namhs;
                window.location.href = url;
            });
            $('#mota').change(function() {
                var namhs = '&nam='+ $('#nam').val();
                var mota = '&mota=' + $('#mota').val();
                var url = '/timkiemgiatacn?'+namhs + mota;
                window.location.href = url;
            });
...
@section('content')
    ...
    <h3 class="page-title">
        Tìm kiếm thông tin kê khai giá<small>&nbsp;thức ăn chăn nuôi</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('timkiemgiatacn/printf?&nam='.$inputs['nam'].'&mota='.$inputs['mota'])}}" class="btn btn-default btn-sm" target="_blank">
