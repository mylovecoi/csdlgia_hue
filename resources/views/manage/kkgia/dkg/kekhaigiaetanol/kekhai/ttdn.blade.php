    ...
    <script>
        ...
        $(function(){
            $('#maxa').change(function() {
                ...
                var url = '/thongtindnkkgiaetanol?'+manghe + maxa;
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($model as $key=>$tt)
                                <tr>
                                    ...
                                    <td>{{$tt->diachi}}</td>
                                    <td>
                                        <a href="{{url('kkgiaetanol/?&manghe='.$inputs['manghe'].'&maxa='.$tt->maxa)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-plus"></i>&nbsp;Kê khai giá</a>
                                    </td>
                                </tr>
                            @endforeach
