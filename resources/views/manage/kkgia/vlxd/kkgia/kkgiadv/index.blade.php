...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiavlxd?&madv='+$('#madv').val()+'&nam='+nam ;
...
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('kekhaigiavlxd/create?&madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            <i class="fa fa-plus"></i> Kê khai mới </a>
                        <a href="{{url('kekhaigiavlxd/nhanexcel?madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_4">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{url('kekhaigiavlxd/prints?&mahs='.$tt->mahs)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                    @if(canEdit($tt->trangthai))
                                        <a href="{{url('kekhaigiavlxd/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'kekhaigiavlxd/delete','id' => 'frm_delete'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
