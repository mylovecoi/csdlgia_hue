...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiakcbtn?&madv='+$('#madv').val()+'&nam='+nam ;
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        ...
                        <a href="{{url('kekhaigiakcbtn/nhanexcel?madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(canEdit($tt->trangthai))
                                        <a href="{{url('kekhaigiakcbtn/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
