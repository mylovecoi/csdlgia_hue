    ...
    <script>
        ...
        $(function(){
            ...
            $('#mota').change(function() {
                ...
                var url = '/timkiemgiakcbtn?'+namhs + mota;
                window.location.href = url;
            });
...
@section('content')
    ...
    <h3 class="page-title">
        Tìm kiếm thông tin kê khai giá<small>&nbsp;khám chữa bệnh</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('timkiemgiakcbtn/printf?&nam='.$inputs['nam'].'&mota='.$inputs['mota'])}}" class="btn btn-default btn-sm" target="_blank">
