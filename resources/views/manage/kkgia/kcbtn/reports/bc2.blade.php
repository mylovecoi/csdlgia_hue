...
<p style="text-align: center; font-weight: bold; font-size: 16px;text-transform: uppercase;">BÁO CÁO KÊ KHAI Giá khám chữa bệnh</p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="active" colspan="8">{{$tt->tendn}}
                ...
                -<b>Mã hồ sơ:</b> <a href="{{ url('kekhaigiakcbtn/prints?mahs=' . $tt->mahs) }}">
                    {{$tt->mahs}}
                </a>
                . Số công văn :{{$tt->socv}} -
