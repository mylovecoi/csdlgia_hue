    ...
    <script>
        ...
        $(function() {
            $('#nam').change(function() {
                ...
                var url = '/xetduyetkkgiahplx?' + namhs + madv + '&trangthai=' + $('#trangthai').val();
        ...
        function confirmNhanHs(mahs) {
            ...
            //alert(id);
            $.ajax({
                url: '/xetduyetkkgiahplx/ttnhanhs',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
        ...
        function confirmNhanHsedit(mahs) {
            ...
            $.ajax({
                url: '/xetduyetkkgiahplx/nhanhsedit',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
        ...
        function confirmHuyduyet(mahs) {
            ...
            $.ajax({
                url: '/xetduyetkkgiahplx/tthuyduyet',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="modal fade" id="tralai-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url' => 'xetduyetkkgiahplx/tralai', 'id' => 'frm_tralai']) !!}
        ...
        <div class="modal fade" id="nhanhs-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url' => 'xetduyetkkgiahplx/nhanhs', 'id' => 'frm_nhanhs']) !!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        ...
        <div class="modal fade" id="nhanhsedit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url' => 'xetduyetkkgiahplx/nhanhsedit', 'id' => 'frm_nhanhsedit']) !!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        ...
        <div class="modal fade" id="huyduyet-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url' => 'xetduyetkkgiahplx/huyduyet', 'id' => 'frm_huyduyet']) !!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
