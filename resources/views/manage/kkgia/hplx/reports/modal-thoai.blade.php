    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header modal-header-primary">
                ...
                <h4 id="modal-header-primary-label" class="modal-title">Báo cáo tổng hợp kê khai giá học phí lái xe</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" data-dismiss="modal" class="btn btn-success" onclick="ClickBC1('/baocaokekhaihplx/bc1')">BC Tổng hợp</button>
                <button type="submit" data-dismiss="modal" class="btn btn-success" onclick="ClickBC2('/baocaokekhaihplx/bc2')">BC chi tiét</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
