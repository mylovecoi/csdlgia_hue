...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiaetanol?&madv='+$('#madv').val()+'&nam='+nam ;
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        ...
                        <a href="{{url('kekhaigiaetanol/nhanexcel?madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(canEdit($tt->trangthai))
                                        <a href="{{url('kekhaigiaetanol/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
