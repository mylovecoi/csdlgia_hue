...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai hồ sơ giá <small>&nbsp;sách chỉnh sửa</small>
        <p><h5 style="color: blue">{{$modeldn->tendn}}&nbsp;- Mã số thuế: {{$modeldn->madv}}</h5></p>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'post', 'url'=>'kekhaigiasach/store', 'class'=>'horizontal-form','id'=>'update_kkgiasach']) !!}
        ...
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('kekhaigiasach?&madv='.$model->madv)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_kkgiasach").validate({
                rules: {
                    ten :"required"
                },
                messages: {
