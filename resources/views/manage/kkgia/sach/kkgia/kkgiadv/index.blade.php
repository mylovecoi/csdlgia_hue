...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiasach?&madv=' + $('#madv').val() + '&nam=' + nam + '&trangthai=' + $('#trangthai').val();
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        ...
                        <a href="{{ url('kekhaigiasach/nhanexcel?madv=' . $inputs['madv']) }}" class="btn btn-default btn-sm">
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('kekhaigiasach/prints?&mahs=' . $tt->mahs) }}" target="_blank"
                                            class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi
                                            tiết</a>
                                        @if (canEdit($tt->trangthai))
                                            <a href="{{ url('kekhaigiasach/edit?mahs=' . $tt->mahs) }}"
