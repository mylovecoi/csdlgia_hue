...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiaxemaynksx?&madv='+$('#madv').val()+'&nam='+nam ;
...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai giá<small>&nbsp;xe máy nhập khẩu, sản xuất</small>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('kekhaigiaxemaynksx/create?&madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(canEdit($tt->trangthai))
                                        <a href="{{url('kekhaigiaxemaynksx/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
