...
@section('content')
    ...
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'post', 'url'=>'kekhaigiaxemaynksx/store', 'class'=>'horizontal-form','id'=>'update_kkgiaxm']) !!}
        ...
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('kekhaigiaxemaynksx?&madv='.$model->madv)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
