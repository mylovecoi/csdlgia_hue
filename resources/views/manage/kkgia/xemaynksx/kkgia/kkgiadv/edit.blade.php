...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai hồ sơ giá <small>&nbsp;xe máy nhập khẩu, sản xuất chỉnh sửa</small>
        <p>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::input('date', 'ngaynhap', null, ['id' => 'ngaynhap', 'class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Ngày thực hiện mức giá kê khai<span
                                        class="require">*</span></label>
                                {!! Form::input('date', 'ngayhieuluc', null, ['id' => 'ngayhieuluc', 'class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
                        <!--/span-->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('socv', null, ['id' => 'socv', 'class' => 'form-control required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('socvlk', null, ['id' => 'socvlk', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Ngày nhập số công văn liền kề<span
                                        class="require">*</span></label>
                                {!! Form::input('date', 'ngaycvlk', $model->ngaycvlk != '' ? date('d/m/Y', strtotime($model->ngaycvlk)) : '', [
                                    'id' => 'ngaycvlk',
                                    'class' => 'form-control',
                                ]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group"><label for="selGender" class="control-label">Các yếu tố chi phí cấu
                                    thành giá (đối với kê khai lần đầu); phân tích nguyên nhân, nêu rõ biến động của các yếu
                                    tố hình thành giá tác động làm tăng hoặc giảm giá (đối với kê khai lại).</label>
                                <div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group"><label for="selGender" class="control-label">Các trường hợp ưu đãi, giảm
                                    giá; điều kiện áp dụng giá (nếu có).</label>
                                <div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="button" data-target="#modal-create" data-toggle="modal"
                                    class="btn btn-success btn-xs" onclick="clearForm()"><i class="fa fa-plus"></i>&nbsp;Kê
                                    khai bổ sung dịch vụ</button>
                                &nbsp;
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" data-target="#modal-edit" data-toggle="modal"
                                                    ...
                                                    onclick="editTtPh({{ $tt->id }});"><i
                                                        class="fa fa-edit"></i>&nbsp;Chỉnh sửa thông tin</button>
                                                <button type="button" data-target="#modal-delete" data-toggle="modal"
                                                    class="btn btn-default btn-xs mbs"
                                                    onclick="getid({{ $tt->id }});"><i
            ...
            <div style="text-align: center">
                <a href="{{ url('kekhaigiaxemaynksx?&madv=' . $model->madv) }}" class="btn btn-danger"><i
    ...
    <script type="text/javascript">
        function validateForm() {
            ...
            var validator = $("#update_kkgiaxm").validate({
                rules: {
                    ten: "required"
                },
                messages: {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="ttpthemmoi">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-control-label"><b>Tên dịch vụ cung ứng</b><span
                                        class="require">*</span></label>
                                {!! Form::text('tendvcu', null, ['id' => 'tendvcu', 'class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('qccl', null, ['id' => 'qccl', 'class' => 'form-control', 'rows' => '3']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label"><b>Giá kê khai hiện hành</b><span
                                        class="require">*</span></label>
                                <input type="text" name="gialk" id="gialk" class="form-control"
                                    data-mask="fdecimal" style="text-align: right;font-weight: bold">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label"><b>Giá kê khai mới</b><span
                                        class="require">*</span></label>
                                <input type="text" name="giakk" id="giakk" class="form-control"
                                    data-mask="fdecimal" style="text-align: right;font-weight: bold">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('ghichu', null, ['id' => 'ghichu', 'class' => 'form-control', 'rows' => '2']) !!}
                            </div>
                        </div>
                    </div>
                </div>
