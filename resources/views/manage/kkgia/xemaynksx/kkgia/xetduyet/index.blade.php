    ...
    <script>
        ...
        $(function() {
            $('#nam').change(function() {
                ...
                var url = '/xetduyetgiaxemaynksx?' + namhs + madv + '&trangthai=' + $('#trangthai').val();
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin xét duyệt kê khai giá<small>&nbsp;xe máy nhập khẩu, sản xuất</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
                            ...
                            <tbody>
                                @foreach ($model as $key => $tt)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('kekhaigiaxemaynksx/prints?&mahs=' . $tt->mahs) }}"
