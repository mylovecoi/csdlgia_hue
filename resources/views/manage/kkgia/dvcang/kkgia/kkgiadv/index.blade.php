...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiadvcang?&madv=' + $('#madv').val() + '&nam=' + nam + '&trangthai=' + $('#trangthai').val();
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('kekhaigiadvcang/prints?&mahs=' . $tt->mahs) }}" target="_blank"
                                            class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi
                                            tiết</a>
                                        @if (canEdit($tt->trangthai))
                                            <a href="{{ url('kekhaigiadvcang/edit?mahs=' . $tt->mahs) }}"
