...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai hồ sơ giá <small>&nbsp;giấy thêm mới</small>
        <p><h5 style="color: blue">{{$modeldn->tendn}}&nbsp;- Mã số thuế: {{$modeldn->maxa}}</h5></p>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::open(['url'=>'kekhaigiagiay', 'id' => 'create_kkgiagiay', 'class'=>'horizontal-form']) !!}
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_kkgiagiay").validate({
                rules: {
                    ten :"required"
                },
                messages: {
