    ...
    <script>
        ...
        $(function() {
            $('#nam').change(function() {
                ...
                var url = '/xetduyetgiagiay?' + namhs + madv + '&trangthai=' + $('#trangthai').val();
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin xét duyệt kê khai giá<small>&nbsp;giấy</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
    ...
    <div class="row">
                            ...
                            <tbody>
                                @foreach ($model as $key => $tt)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('kekhaigiagiay/prints?&mahs=' . $tt->mahs) }}" target="_blank"
        ...
        <div class="modal fade" id="nhanhsedit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url' => 'xetduyetgiagiay/nhanhsedit', 'id' => 'frm_nhanhsedit']) !!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
