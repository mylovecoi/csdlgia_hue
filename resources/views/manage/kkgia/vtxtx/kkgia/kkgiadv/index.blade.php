...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiavantaixetaxi?&madv='+$('#madv').val()+'&nam='+nam + '&trangthai=' + $('#trangthai').val();
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('kekhaigiavantaixetaxi/create?&madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            <i class="fa fa-plus"></i> Kê khai mới </a>
                        <a href="{{url('kekhaigiavantaixetaxi/nhanexcel?madv='.$inputs['madv'])}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(canEdit($tt->trangthai))
                                        <a href="{{url('kekhaigiavantaixetaxi/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs">
