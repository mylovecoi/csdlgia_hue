...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiavantaixetaxi?&madv=' + $('#madv').val() + '&nam=' + nam + '&trangthai=' + $('#trangthai')
                .val();
                ...
                <div class="portlet-title">
                    <div class="actions">
                        @if (!empty($inputs['madv']) && $inputs['madv'] != 'ALL')
                            {
                            <a href="{{ url('kekhaigiavantaixetaxi/create?&madv=' . $inputs['madv']) }}"
                                class="btn btn-default btn-sm">
                                <i class="fa fa-plus"></i> Kê khai mới </a>
                            <a href="{{ url('kekhaigiavantaixetaxi/nhanexcel?madv=' . $inputs['madv']) }}"
                                class="btn btn-default btn-sm">
