...
@section('content')
    ...
    <table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;" id="data">
        ...
        <tr>
            ...
            <th colspan="5" style="text-align: center">Kê khai giá</th>
            <th colspan="5" style="text-align: center">Kê khai giá</th>
            <th colspan="5" style="text-align: center">Kê khai giá</th>
        ...
        <tr>
            ...
            <th style="text-align: center">Tỷ<br>lệ %<br>tăng<br>giảm</th>
            <th style="text-align: center">Số Km</th>
            <th style="text-align: center">Giá<br>kê<br>khai</th>
            <th style="text-align: center">Giá<br>liền<br>kề</th>
            <th style="text-align: center">Mức<br>tăng<br>giảm</th>
        ...
        @foreach($modelkkct as $key=>$tt)
            <tr>
                ...
                <td style="text-align: right">{{number_format($tt->giacl)}}</td>
                <td style="text-align: center">{{$tt->giapt}}</td>

                <td>{{$tt->sokm1}}</td>
                <td style="text-align: right">{{number_format($tt->gialk1)}}</td>
                <td style="text-align: right">{{number_format($tt->giakk1)}}</td>
                <td style="text-align: right">{{number_format($tt->giacl1)}}</td>
                <td style="text-align: center">{{$tt->giapt1}}</td>
                <td>{{$tt->sokm2}}</td>
                <td style="text-align: right">{{number_format($tt->gialk2)}}</td>
                <td style="text-align: right">{{number_format($tt->giakk2)}}</td>
                <td style="text-align: right">{{number_format($tt->giacl2)}}</td>
                <td style="text-align: center">{{$tt->giapt2}}</td>
    ...
    <table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;" id="data">
        <tr>
            ...
            <th rowspan="2"  style="text-align: center">Tên dịch vụ cung ứng</th>
            <th rowspan="2" >Quy cách, <br>chất lượng</th>
            <th rowspan="2" >Đơn vị<br>tính</th>
            <th colspan="3">Mức giá <br>đăng ký hiện<br>hành</th>
            <th colspan="3">Mức giá <br>đăng ký mới</th>
            <th colspan="3">Mức tăng giảm</th>
            <th colspan="3">Tỷ lệ % tăng giảm</th>
            <th rowspan="2" >Ghi chú</th>
        </tr>
        <tr>
            <th style="text-align: center">{{$inputs['sokm']}}</th>
            <th style="text-align: center">{{$inputs['sokm1']}}</th>
            <th style="text-align: center">{{$inputs['sokm2']}}</th>
