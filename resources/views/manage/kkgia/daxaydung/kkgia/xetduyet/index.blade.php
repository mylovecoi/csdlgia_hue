    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                ...
                var url = '/xetduyetkkgiadaxaydung?'+namhs+madv;
...
//            alert(madv);
        ...
        function confirmNhanHs(mahs){
            ...
            //alert(id);
            $.ajax({
                url: '/xetduyetkkgiadaxaydung/ttnhanhs',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
        ...
        function confirmNhanHsedit(mahs){
            ...
            $.ajax({
                url: '/xetduyetkkgiadaxaydung/nhanhsedit',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
        ...
        function confirmHuyduyet(mahs){
            ...
            $.ajax({
                url: '/xetduyetkkgiadaxaydung/tthuyduyet',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin xét duyệt kê khai giá<small>&nbsp;đá xây dựng</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
    ...
    <div class="row">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($model as $key=>$tt)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{url('kekhaigiadaxaydung/prints?&mahs='.$tt->mahs)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                        @if($tt->level == 'ADMIN')
                                            @if($tt->trangthai == 'CB')
        ...
        <div class="modal fade" id="tralai-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'xetduyetkkgiadaxaydung/tralai','id' => 'frm_tralai'])!!}
        ...
        <div class="modal fade" id="nhanhs-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'xetduyetkkgiadaxaydung/nhanhs','id' => 'frm_nhanhs'])!!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        ...
        <div class="modal fade" id="nhanhsedit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'xetduyetkkgiadaxaydung/nhanhsedit','id' => 'frm_nhanhsedit'])!!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        ...
        <div class="modal fade" id="huyduyet-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'xetduyetkkgiadaxaydung/huyduyet','id' => 'frm_huyduyet'])!!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
