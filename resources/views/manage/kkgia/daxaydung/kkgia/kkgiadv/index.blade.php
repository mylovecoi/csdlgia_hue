...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiadaxaydung?&madv=' + $('#madv').val() + '&nam=' + nam + '&trangthai=' + $('#trangthai')
            .val();
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{ url('kekhaigiadaxaydung/create?&madv=' . $inputs['madv']) }}"
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('kekhaigiadaxaydung/prints?&mahs=' . $tt->mahs) }}" target="_blank"
                                            class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi
                                            tiết</a>
                                        @if (canEdit($tt->trangthai))
                                            <a href="{{ url('kekhaigiadaxaydung/edit?mahs=' . $tt->mahs) }}"
