...
<p style="text-align: center; font-weight: bold; font-size: 16px;text-transform: uppercase;">BÁO CÁO KÊ KHAI Giá đá xây dựng</p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="active" colspan="8">{{$tt->tendn}}
                ...
                -<b>Mã hồ sơ:</b> <a href="{{ url('kekhaigiadaxaydung/prints?mahs=' . $tt->mahs) }}">
                    {{$tt->mahs}}
                </a>
                . Số công văn :{{$tt->socv}} -
