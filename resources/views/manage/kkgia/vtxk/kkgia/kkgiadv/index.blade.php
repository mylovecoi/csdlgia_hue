...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiavantaixekhach?&madv=' + $('#madv').val() + '&nam=' + nam + '&trangthai=' + $('#trangthai')
                .val();
                ...
                <div class="portlet-title">
                    <div class="actions">
                        @if (!empty($inputs['madv']) && $inputs['madv'] != 'ALL')
                            {
                            <a href="{{ url('kekhaigiavantaixekhach/create?&madv=' . $inputs['madv']) }}"
                                class="btn btn-default btn-sm">
                                <i class="fa fa-plus"></i> Kê khai mới </a>
                            <a href="{{ url('kekhaigiavantaixekhach/nhanexcel?madv=' . $inputs['madv']) }}"
                                class="btn btn-default btn-sm">
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('kekhaigiavantaixekhach/prints?&mahs=' . $tt->mahs) }}"
                                            target="_blank" class="btn btn-default btn-xs mbs"><i
                                                class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                        @if (canEdit($tt->trangthai))
                                            <a href="{{ url('kekhaigiavantaixekhach/edit?mahs=' . $tt->mahs) }}"
