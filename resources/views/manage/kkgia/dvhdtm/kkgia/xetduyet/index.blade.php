    ...
    <script>
        ...
        $(function() {
            $('#nam').change(function() {
                ...
                var url = '/xetduyetkkgiadvhdtm?' + namhs + madv + '&trangthai=' + $('#trangthai').val();
        ...
        function confirmNhanHsedit(mahs) {
            ...
            $.ajax({
                url: '/xetduyetkkgiadvhdtm/nhanhsedit',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
        ...
        function confirmHuyduyet(mahs) {
            ...
            $.ajax({
                url: '/xetduyetkkgiadvhdtm/tthuyduyet',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin xét duyệt kê khai giá<small>&nbsp;dịch vụ thương mại</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
