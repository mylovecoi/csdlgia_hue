                ...
                <div class="portlet-title">
                    <div class="actions">
                        @if (!empty($inputs['madv']) && $inputs['madv'] != 'ALL')
                            {
                            <a href="{{ url('kekhaigiadvhdtm/create?&madv=' . $inputs['madv']) }}"
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('kekhaigiadvhdtm/prints?&mahs=' . $tt->mahs) }}" target="_blank"
                                            class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi
                                            tiết</a>
                                        @if (canEdit($tt->trangthai))
                                            <a href="{{ url('kekhaigiadvhdtm/edit?mahs=' . $tt->mahs) }}"
