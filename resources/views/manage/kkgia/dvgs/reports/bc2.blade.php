...
@section('content')
    ...
    <p style="text-align: center; font-weight: bold; font-size: 16px;text-transform: uppercase;">BÁO CÁO KÊ KHAI Giá thực phẩm chức năng cho trẻ em dưới 6 tuổi</p>
        ...
        @foreach($model as $key=>$tt)
            <tr>
                ...
                <td class="active" colspan="8">{{$tt->tendn}}
                    ...
                    -<b>Mã hồ sơ:</b> <a href="{{ url('kekhaigiatpcnte6t/prints?mahs=' . $tt->mahs) }}">
                    {{$tt->mahs}}
                </a>
                    . Số công văn :{{$tt->socv}} -
