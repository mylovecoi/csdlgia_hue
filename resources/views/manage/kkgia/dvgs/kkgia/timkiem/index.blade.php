...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                var namhs = $('#nam').val();
                var url = '/timkiemkkkgiatpcnte6t?'+namhs;
                window.location.href = url;
            });
            $('#mota').change(function() {
                var namhs = '&nam='+ $('#nam').val();
                var mota = '&mota=' + $('#mota').val();
                var url = '/timkiemkkkgiatpcnte6t?'+namhs + mota;
                window.location.href = url;
            });
...
@section('content')
    ...
    <h3 class="page-title">
        Tìm kiếm thông tin kê khai giá<small>&nbsp;thực phẩm chức năng cho trẻ em dưới 6 tuổi</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('timkiemkkkgiatpcnte6t/printf?&nam='.$inputs['nam'].'&mota='.$inputs['mota'])}}" class="btn btn-default btn-sm" target="_blank">
