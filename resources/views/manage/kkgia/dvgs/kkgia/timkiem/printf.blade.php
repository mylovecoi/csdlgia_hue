                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <h2 class="page-title" style="text-align: center;text-transform: uppercase">
                                    Tìm kiếm thông tin kê khai giá thực phẩm chức năng cho trẻ em dưới 6 tuổi
                                </h2>
                            </div>
                            <br>
                            {{--<div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        &emsp;Từ khóa:
                                        &emsp;Năm : "{{ isset($inputs['nam']) ? $inputs['nam'] : null }}" +
                                        Mô tả : "{{ isset($inputs['mota']) ? $inputs['mota'] : null }}"
                                    </div><br>
                                </div>
                            </div>--}}
                        </div>
