...
@section('custom-script')
    ...
    <script>
        ...
        function changeUrl() {
            var nam = $('#namhs').val();
            var url = '/kekhaigiatpcnte6t?&madv=' + $('#madv').val() + '&nam=' + nam + '&trangthai=' + $('#trangthai')
        .val();
...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai giá<small>&nbsp;thực phẩm chức năng cho trẻ em dưới 6 tuổi</small>
        <p>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{ url('kekhaigiatpcnte6t/create?&madv=' . $inputs['madv']) }}"
                            class="btn btn-default btn-sm">
                            <i class="fa fa-plus"></i> Kê khai mới </a>
                        <a href="{{ url('kekhaigiatpcnte6t/nhanexcel?madv=' . $inputs['madv']) }}"
                            class="btn btn-default btn-sm">
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('kekhaigiatpcnte6t/prints?&mahs=' . $tt->mahs) }}" target="_blank"
                                            class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi
                                            tiết</a>
                                        @if (canEdit($tt->trangthai))
                                            <a href="{{ url('kekhaigiatpcnte6t/edit?mahs=' . $tt->mahs) }}"
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => 'kekhaigiatpcnte6t/delete', 'id' => 'frm_delete']) !!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
