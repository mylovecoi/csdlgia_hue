    ...
    <div class="row">
        ...
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group"><label for="selGender" class="control-label">Các yếu tố chi phí cấu
                                ...
                                <div>
                                    <textarea id="ytcauthanhgia" class="form-control" name="ytcauthanhgia" cols="30" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div style="text-align: center">
                <a href="{{ url('kekhaigiaxmtxd?&masothue=' . $inputs['masothue']) }}" class="btn btn-danger"><i
