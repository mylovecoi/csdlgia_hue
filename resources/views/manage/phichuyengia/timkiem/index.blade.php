...
@section('content')
    <h3 class="page-title">
        Tìm kiếm giá hàng hóa chuyển từ phí sang giá
    </h3>
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'phichuyengia/timkiem', 'method'=>'post' , 'id' => 'create_timkiem', 'class'=>'horizontal-form']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2me" name="maso" id="maso">
