        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(chkPer('csdlmucgiahhdv','philephi', 'phichuyengia', 'hoso', 'modify'))
                    ...
                    <table id="sample_4" class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    @if(chkPer('csdlmucgiahhdv','philephi', 'phichuyengia', 'hoso', 'modify') && in_array($tt->trangthai,['CHT', 'HHT']))
                                    ...
                                    @endif
                                    @if(chkPer('csdlmucgiahhdv','philephi', 'phichuyengia', 'hoso', 'approve')&& in_array($tt->trangthai,['CHT', 'HHT']))
