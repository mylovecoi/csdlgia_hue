...
@section('content')
    <h3 class="page-title">
        Tìm kiếm<small> giá sản phẩm, dịch vụ công ích, dịch vụ sự nghiệp công và hàng hóa, dịch vụ được địa phương đặt hàng, giao kế hoạch sản xuất, kinh doanh </small>
    </h3>
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'giaspdvci/timkiem', 'method'=>'post' , 'id' => 'create_timkiem', 'class'=>'horizontal-form']) !!}
