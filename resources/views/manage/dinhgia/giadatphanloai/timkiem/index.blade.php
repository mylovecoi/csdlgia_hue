...
@section('content')
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'giadatphanloai/timkiem', 'method'=>'post' , 'id' => 'create_timkiem', 'class'=>'horizontal-form']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2me" name="maloaidat" id="maloaidat">
                                        <option value="all">-- Tất cả các phân loại --</option>
                                        @foreach($a_loaidat as $key=>$val)
