...
@section('content')
    <h3 class="page-title">
        Tìm kiếm<small> thông tin giá hàng hóa, dịch vụ</small>
    </h3>
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Nhóm hàng hóa</label>
                                    <select class="form-control select2me" name="madoituong" id="madoituong">
