...
@section('content')
    <table id="data_header" width="96%" border="0" cellspacing="0" cellpadding="8"
        ...
        <tr style="text-align: center; font-weight: bold; font-size: 16px;">
            <td colspan="2"> BÁO CÁO GIÁ THỊ TRƯỜNG HÀNG HÓA, DỊCH VỤ</td>
        </tr>
    </table>
                ...
                @foreach ($chitiet as $ct)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            {{ dinhdangsothapphan($ct['phantram'], 5) . ($ct['phantram'] != 0 ? '%' : '') }}</td>
                        <td></td>
                    </tr>
                @endforeach
            @endforeach
    ...
    <table width="96%" border="0" cellspacing="0" height cellpadding="0"
        style="margin: 20px auto;text-align: center; height:200px" id="data_footer">
        <tr>
