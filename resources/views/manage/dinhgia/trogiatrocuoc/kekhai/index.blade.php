...
@section('content')
    <h3 class="page-title">
        Hồ sơ <small>mức trợ giá, trợ cước</small>
    </h3>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(chkPer('csdlmucgiahhdv','dinhgia', 'trogiatrocuoc', 'hoso', 'modify'))
                    ...
                    <table id="sample_3" class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'trogiatrocuoc', 'hoso', 'modify') && in_array($tt->trangthai,['CHT', 'HHT']))
                                    ...
                                    @endif
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'trogiatrocuoc', 'hoso', 'approve')&& in_array($tt->trangthai,['CHT', 'HHT']))
