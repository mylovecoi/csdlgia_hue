...
@section('content')
    <h3 class="page-title text-uppercase">
        Tìm kiếm {{session('admin')['a_chucnang']['giaspdvkhunggia'] ?? 'Giá sản phẩm, dịch vụ khung giá'}}
    </h3>
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('tenspdv', null, array('class' => 'form-control'))!!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Mức giá - Từ</label>
                                    {!!Form::text('dongia_tu', null, array('class' => 'form-control','data-mask'=>'fdecimal'))!!}
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Mức giá - Đến</label>
                                    {!!Form::text('dongia_den', null, array('class' => 'form-control','data-mask'=>'fdecimal'))!!}
                                </div>
                            </div>
                            <!--/span-->
                        </div>
