...
@section('content')
    <h3 class="page-title text-uppercase">
        {{session('admin')['a_chucnang']['giaspdvkhunggia'] ?? 'Giá sản phẩm, dịch vụ khung giá'}}
    </h3>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(chkPer('csdlmucgiahhdv','dinhgia', 'giaspdvkhunggia', 'hoso', 'modify'))
                    ...
                    <table id="sample_3" class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'giaspdvkhunggia', 'hoso', 'modify') && in_array($tt->trangthai,['CHT', 'HHT']))
                                    ...
                                    @endif
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'giaspdvkhunggia', 'hoso', 'approve')&& in_array($tt->trangthai,['CHT', 'HHT']))
