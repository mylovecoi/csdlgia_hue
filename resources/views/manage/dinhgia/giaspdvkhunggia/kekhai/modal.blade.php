                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="giatoithieu" class="form-control" data-mask="fdecimal">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label">Mức giá tối đa</label>
                            <input type="text" name="giatoida" class="form-control" data-mask="fdecimal">
                        </div>
                    </div>
                </div>
    ...
    function capnhatts(){
        ...
        $.ajax({
            ...
            data: {
                ...
                giatoida: form.find("[name='giatoida']").val(),
                giatoithieu: form.find("[name='giatoithieu']").val(),
