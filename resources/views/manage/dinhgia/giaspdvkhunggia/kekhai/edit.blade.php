...
@section('content')
    <h3 class="page-title text-uppercase">
        Hồ sơ {{session('admin')['a_chucnang']['giaspdvkhunggia'] ?? 'Giá sản phẩm, dịch vụ khung giá'}}
    </h3>
    <!-- END PAGE HEADER-->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_3">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center" width="15%">Mức giá<br>tối thiểu</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="ttmhbog">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Mức giá tối thiểu</label>
                                <input type="text" id="giatoithieu" name="giatoithieu" data-mask="fdecimal" class="form-control" style="font-weight: bold;text-align: right">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Mức giá tối đa</label>
                                <input type="text" id="giatoida" name="giatoida" data-mask="fdecimal" class="form-control" style="font-weight: bold;text-align: right">
                            </div>
                        </div>
                    </div>
                </div>
