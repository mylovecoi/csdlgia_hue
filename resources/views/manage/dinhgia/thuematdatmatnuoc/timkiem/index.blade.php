...
@section('content')
    <h3 class="page-title">
        Tìm kiếm<small> thông tin hồ sơ thuê mặt đất, mặt nước</small>
    </h3>
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'giathuematdatmatnuoc/timkiem', 'method'=>'post' , 'id' => 'create_timkiem', 'class'=>'horizontal-form']) !!}
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Vị trí cho thuê</label>
                                    {!!Form::text('vitri',null, array('id' => 'vitri','class' => 'form-control', 'autofocus'))!!}
                                </div>
                            </div>
                        </div>
