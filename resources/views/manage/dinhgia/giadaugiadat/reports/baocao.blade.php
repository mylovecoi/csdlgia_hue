...
@section('content')
    ...
    <p style="text-align: center;font-weight: bold;font-size: 20px">DANH SÁCH HỒ SƠ GIÁ ĐẤU GIÁ ĐẤT</p>
    ...
    <table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;" id="data">
        <tr>
            ...
            <th style="text-align: center">Số quyết định</br>công nhận kết</br>quả trúng đấu giá</th>
        ...
        @foreach($model as $key=>$ct)
            <tr>
                ...
                <td>{{$ct->soqdkqdaugia}}</td>
                <td>{{getDayVn($ct->thoidiem)}}</td>
                <td>{{$ct->tenduan}}</td>
                <td>{{$ct->ghichu}}</td>
