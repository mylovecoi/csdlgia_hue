                ...
                <div class="portlet-body form-horizontal">
                        ...
                        <tbody>
                            @foreach($model as $key=>$tt)
                                <tr>
                                    ...
                                    <td>{{$tt->tenduan}}</td>
                                    <td style="text-align: center">{{dinhdangso($tt->giakhoidiem)}}</td>
                                    <td style="text-align: center">{{dinhdangso($tt->giadauthau)}}</td>
                                </tr>
                            @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: center">
                            <a href="{{url('giadaugiadat/timkiem')}}" class="btn btn-danger">
