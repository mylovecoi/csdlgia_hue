...
@section('content')
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'giarung/timkiem', 'method'=>'post' , 'id' => 'create_timkiem', 'class'=>'horizontal-form']) !!}
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Phân loại rừng</label>
                                    <select class="form-control select2me" name="manhom" id="manhom">
                                        <option value="all">-- Tất cả các phân loại --</option>
                                        @foreach($a_loairung as $key=>$val)
