...
<p style="text-align: center;font-weight: bold;font-size: 20px; text-transform: uppercase;">TỔNG HỢP GIÁ DỊCH VỤ MÔI TRƯỜNG RỪNG</p>
...
<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;" id="data">
    <thead>
        <tr>
            ...
            <th colspan="2" style="text-align: center">Quyết định cho thuê</th>
            <th colspan="3" style="text-align: center">Giá cho thuê</th>
            <th colspan="2" style="text-align: center">Thời gian thuê</th>
    ...
    <tbody>
        ...
        @foreach($model as $key => $tt)
            <tr>
                ...
                <td>{{$tt->dvthue}}</td>
                <td style="text-align: center">{{dinhdangsothapphan($tt->dientich,2)}}</td>
                <td>{{$tt->diachi}}</td>
                ...
                <td style="text-align: center">{{getDayVn($tt->thuetungay)}}</td>
                <td style="text-align: center">{{getDayVn($tt->thuedenngay)}}</td>
                <td></td>
            </tr>
        @endforeach
        <tr style="font-weight: bold" class="text-right;">
            <td colspan="2">Tổng cộng</td>
            <td style="text-align: center">{{dinhdangsothapphan($model->sum('dientich'),2)}}</td>
            <td></td>
            <td></td>
            <td></td>
