...
@section('content')
    <h3 class="page-title text-uppercase">
        Tìm kiếm {{session('admin')['a_chucnang']['giaspdvcuthe'] ?? 'Giá sản phẩm, dịch vụ cụ thể'}}
    </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('mota', null, array('class' => 'form-control'))!!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('mucgia_tu', null, array('class' => 'form-control','data-mask'=>'fdecimal'))!!}
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('mucgia_den', null, array('class' => 'form-control','data-mask'=>'fdecimal'))!!}
                                </div>
                            </div>
                            <!--/span-->
                        </div>
