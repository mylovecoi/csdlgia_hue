        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        @if(chkPer('csdlmucgiahhdv','dinhgia', 'giacuocvanchuyen', 'hoso', 'modify'))
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'giacuocvanchuyen', 'hoso', 'modify') && in_array($tt->trangthai,['CHT', 'HHT']))
                                    ...
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'giacuocvanchuyen', 'hoso', 'approve')&& in_array($tt->trangthai,['CHT', 'HHT']))
