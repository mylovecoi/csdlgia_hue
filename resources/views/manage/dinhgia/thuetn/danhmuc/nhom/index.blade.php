                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        @if ($tt->theodoi == 'TD')
                                            @if (chkPer('csdlmucgiahhdv', 'dinhgia', 'giathuetn', 'khac', 'api') &&
                                                ...
                                                <div class="btn-group btn-group-solid">
                                                    ...
                                                    <ul class="dropdown-menu" style="position: static">
                                                        <li>
                                                            <a href="{{ url('/KetNoiAPI/HoSo?maso=dmgiathuetn') }}"
                                                        ...
                                                        <li>
                                                            <button type="button" style="border: none;"
                                                                onclick="ketnoiapi('{{ $tt->manhom }}','dmgiathuetn', '{{ $inputs['url'] . '/xetduyet/' }}')"
                                            ...
                                            @endif
                                            <a href="{{ url($inputs['url'] . '/danhmuc/detail?manhom=' . $tt->manhom) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nhóm tài nguyên</h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="manhom" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Tên nhóm tài nguyên<span class="require">*</span></label>
