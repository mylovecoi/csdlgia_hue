...
@section('content')
    <h3 class="page-title">
        Hồ sơ <small>giá hàng hóa, dịch vụ khác theo quy định của pháp luật chuyên ngành</small>
    </h3>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(chkPer('csdlmucgiahhdv','dinhgia', 'giahhdvcn', 'hoso', 'modify'))
                    ...
                    <table id="sample_3" class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'giahhdvcn', 'hoso', 'modify') && in_array($tt->trangthai,['CHT', 'HHT']))
                                    ...
                                    @endif
                                    @if(chkPer('csdlmucgiahhdv','dinhgia', 'giahhdvcn', 'hoso', 'approve')&& in_array($tt->trangthai,['CHT', 'HHT']))
