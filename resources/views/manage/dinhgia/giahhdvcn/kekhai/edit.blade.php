...
{{--                                    @if($model->ipf1 != '')--}}
{{--                                        <a href="{{url('/data/giahhdvcn/'.$model->ipf1)}}" target="_blank">{{$model->ipf1}}</a>--}}
{{--                                    @endif--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">File đính kèm</label>
                                    @if($model->ipf2 != '')
                                        <a href="{{url('/data/giahhdvcn/'.$model->ipf2)}}" target="_blank">{{$model->ipf2}}</a>
                                    @endif
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">File đính kèm</label>
                                    @if($model->ipf3 != '')
                                        <a href="{{url('/data/giahhdvcn/'.$model->ipf3)}}" target="_blank">{{$model->ipf3}}</a>
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">File đính kèm</label>
                                    @if($model->ipf4 != '')
                                        <a href="{{url('/data/giahhdvcn/'.$model->ipf4)}}" target="_blank">{{$model->ipf4}}</a>
                                    @endif
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">File đính kèm</label>
                                    @if($model->ipf5 != '')
                                        <a href="{{url('/data/giahhdvcn/'.$model->ipf5)}}" target="_blank">{{$model->ipf5}}</a>
                                    @endif
