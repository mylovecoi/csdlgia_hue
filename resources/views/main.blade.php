...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css') }}" />
    @yield('custom-style')
    <!-- END PAGE STYLES -->
    <!-- BEGIN THEME STYLES -->
    <link href="{{ url('assets/global/css/components.css') }}" id="style_components" rel="stylesheet"
        type="text/css" />
    ...
    <script type="text/javascript" src="{{ url('assets/global/plugins/jquery-validation/js/additional-methods.min.js') }}">
    </script>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                        <a href="{{ url('/giahanghoadichvu') }}" class="dropdown-toggle" target="_blank">
                            ...
                            <span class="badge badge-primary">Công bố</span>
                        </a>
                        <ul>
                        </ul>
                    </li>
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    @if (session('admin')->level == 'DN')
                        ...
                        @if (chkPer('csdlkkgia', 'bog'))
                            <li class="tooltips" data-container="body" data-placement="right" data-html="true"
                                ...
                                <ul class="sub-menu">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'bog', 'xangdau'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'bog', 'sted6t'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'bog', 'pdurenpk'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'bog', 'vxgxgc'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Vắc-xin phòng bệnh cho gia súc, gia
                                                    cầm</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'bog', 'tpcb'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Thuốc thuộc danh mục thuốc thiết yếu được
                                                    sử dụng tại cơ sở
                                ...
                                <ul class="sub-menu">
                                    @if (chkPer('csdlkkgia', 'cp', 'xmtxd'))
                                        <li>
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiaxmtxd') }}">Giá kê khai</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'nhao'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'congtrinh'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @if (chkPer('csdlkkgia', 'cp', 'than'))
                                        <li>
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiathan') }}">Giá kê khai</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'etanol'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Etanol nhiên liệu không biến tính, khí tự
                                                    nhiên hóa lỏng(LNG);
                                                    khí thiên nhiên nén (CNG)</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiaetanol') }}">Giá kê khai</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'khi'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'dvcangbien'))
                                        <li>
                                            <a href="javascript:;">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiadvcang') }}">Giá kê khai</a>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'duongsat'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Dịch vụ vận chuyển hành khách bằng đường
                                                    sắt</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'duongbo'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Dịch vụ vận chuyển hành khách bằng đường
                                                    bộ</span>
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'tpcn'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Thực phẩm chức năng cho trẻ em dưới 6
                                                    tuổi</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiatpcnte6t') }}">Giá kê khai</a>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'tbyt'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'kcbtn'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Dịch vụ khám chữa bệnh cho người tại cơ sở
                                                    khám chữa bệnh tư
                                                    nhân; khám chữa bệnh theo yêu cầu tại cơ sở khám chữa bệnh
                                                    của nhà nước</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiakcbtn') }}">Giá kê khai</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'cp', 'vienthong'))
                                        <li>
                                            <a href="javascript:;">
                        ...
                        @if (chkPer('csdlkkgia', 'kknygia'))
                            <li class="tooltips" data-container="body" data-placement="right" data-html="true"
                                ...
                                <ul class="sub-menu">
                                    @if (chkPer('csdlkkgia', 'kknygia', 'dvlt'))
                                        <li>
                                            <a href="javascript:;">
                                            ...
                                            <ul class="sub-menu">
                                                {{-- <li><a href="{{ url('thongtincskd') }}">Danh sách CSKD</a>
                                                        </li> --}}
                                                <li><a href="{{ url('kekhaigiadvlt') }}">Giá kê khai</a>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'trongxe'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'tqbien'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Dịch vụ tham quan tại khu du lịch trên địa
                                                    bàn</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'vtxtx'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Cước vận tải hành khách bằng xe
                                                    taxi</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiavantaixetaxi') }}">Giá kê
                                                        khai</a></li>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'vttqdl'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Dịch vụ vận tải hành khách tham quan du
                                                    lịch</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'vthh'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Dịch vụ vận tải hàng hóa và hành khách
                                                    tuyến cố định bằng
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'vlxd'))
                                        <li>
                                            <a href="javascript:;">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiavlxd') }}">Giá kê khai</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'giongnn'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'chonndg'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Dịch vụ chủ yếu tại chợ ngoài dịch vụ do
                                                    Nhà nước định
                                                    giá</span>
                                                <span class="arrow"></span>
                                            </a>
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'nuockhoang'))
                                        <li>
                                            <a href="javascript:;">
                                    ...
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'cahue'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Giá dịch vụ xem ca Huế trên sông
                                                    Hương</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiadvcahue') }}">Giá kê khai</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                    @if (chkPer('csdlkkgia', 'kknygia', 'hocphilx'))
                                        <li>
                                            <a href="javascript:;">
                                                <span class="title">Mức thu học phí đào tạo lái xe cơ giới
                                                    đường bộ</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ url('kekhaigiahplx') }}">Giá kê khai</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                    ...
                    @if (chkPer('csdlthamdinhgia'))
                        <li class="heading">
                            <h3 class="uppercase">
                                {{ session('admin')['a_chucnang']['csdlthamdinhgia'] ?? 'CSDL thẩm định giá' }}</h3>
                        </li>
                    ...
                    @if (chkPer('csdlvbqlnn'))
                        <li class="heading">
                            <h3 class="uppercase">
                                {{ session('admin')['a_chucnang']['csdlvbqlnn'] ?? 'Văn bản QLNN về giá - phí, lệ phí' }}
                            </h3>
                        </li>
                    ...
                    @if (chkPer('csdlttpvctqlnn'))
                        <li class="heading">
                            <h3 class="uppercase">
                                {{ session('admin')['a_chucnang']['csdlttpvctqlnn'] ?? 'TT phục vụ CT QLNN về giá' }}
                            </h3>
                        </li>
                                ...
                                <li class="tooltips" data-container="body" data-placement="right" data-html="true">
                                    ...
                                    <ul class="sub-menu">
                                        @if (chkPer('hethong', 'hethong_pq', 'nhomtaikhoan'))
                                            <li><a
                                                    href="{{ url('/nhomtaikhoan/danhsach') }}">{{ session('admin')['a_chucnang']['nhomtaikhoan'] ?? 'Danh sách nhóm tài khoản' }}</a>
                                            </li>
                                        @endif

                                        @if (chkPer('hethong', 'hethong_pq', 'danhsachtaikhoan'))
                                            <li><a
                                                    href="{{ url('/taikhoan/danhsach') }}">{{ session('admin')['a_chucnang']['danhsachtaikhoan'] ?? 'Danh sách tài khoản' }}</a>
                                            </li>
                                        @endif

                                        @if (chkPer('hethong', 'hethong_pq', 'dangky'))
                                            <li><a
                                                    href="{{ url('dangky/danhsach') }}">{{ session('admin')['a_chucnang']['dangky'] ?? 'Tài khoản đăng ký' }}</a>
                                            </li>
                                            <li><a href="{{ url('doanhnghiep/dstaikhoan') }}">Tài khoản doanh
                                                    nghiệp</a></li>
                                        @endif
                                    </ul>
                                </li>
                                ...
                                <li class="tooltips" data-container="body" data-placement="right" data-html="true">
                                    ...
                                    <ul class="sub-menu">
                                        @if (chkPer('hethong', 'hethong_pq', 'danhsachdiaban'))
                                            <li><a
                                                    href="{{ url('/diaban/danhsach') }}">{{ session('admin')['a_chucnang']['danhsachdiaban'] ?? 'Danh sách địa bàn' }}</a>
                                            </li>
                                        @endif

                                        @if (chkPer('hethong', 'hethong_pq', 'danhsachxaphuong'))
                                            <li><a
                                                    href="{{ url('/xaphuong/danhsach') }}">{{ session('admin')['a_chucnang']['danhsachxaphuong'] ?? 'Danh sách xã, phường, thị trấn' }}</a>
                                            </li>
                                        @endif

                                        @if (chkPer('hethong', 'hethong_pq', 'danhsachdonvi'))
                                            <li><a
                                                    href="{{ url('/donvi/danhsach') }}">{{ session('admin')['a_chucnang']['danhsachdonvi'] ?? 'Danh sách đơn vị' }}</a>
                                            </li>
                                        @endif

                                        @if (chkPer('hethong', 'hethong_pq', 'chucnang'))
                                            <li><a
                                                    href="{{ url('/chucnang/danhsach') }}">{{ session('admin')['a_chucnang']['chucnang'] ?? 'Danh mục chức năng hệ thống' }}</a>
                                            </li>
                                        @endif
                                        ...
                                        @if (session('admin')->level == 'SSA')
                                            <li><a
                                                    href="{{ url('/vanphonghotro/danhsach') }}">{{ session('admin')['a_chucnang']['vanphong'] ?? 'Văn phòng hỗ trợ' }}</a>
                                            </li>
                                            <li><a href="{{ url('/doanhnghiep/dsdangky') }}">Danh sách doanh nghiệp
                                                    đăng ký</a> </li>
                                        @endif

                                        @if (chkPer('hethong', 'hethong_pq', 'thongtin'))
                                            <li><a
                                                    href="{{ url('/general') }}">{{ session('admin')['a_chucnang']['thongtin'] ?? 'Cấu hình hệ thống' }}</a>
                                            </li>
                                        @endif
                                    </ul>
                                </li>
