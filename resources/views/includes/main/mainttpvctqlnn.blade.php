@if(chkPer('csdlttpvctqlnn','ttpvctqlnn','ctqlnn'))
    <li class="tooltips" data-container="body" data-placement="right" data-html="true"
        ...
        <ul class="sub-menu">
            @if(chkPer('csdlttpvctqlnn','ttpvctqlnn','ctqlnn','danhmuc','index'))
                <li>
                    <a href="{{url('dmttpvctqlnn')}}">Danh mục thông tin</a>
                </li>
            @endif
            @if(chkPer('csdlttpvctqlnn','ttpvctqlnn','ctqlnn','hoso','index'))
