...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(matt) {
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/csdlquocgia/qg_giahhdvk/show_nhomdm',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    matt: matt
...
@section('content')
    <h3 class="page-title">
        Truyền danh mục Giá hàng hóa, dịch vụ thị trường
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <button type="button" onclick="ClickEdit('{{ $tt->matt }}')"
                                                ...
                                                <ul class="dropdown-menu" style="position: static">
                                                    ...
                                                    <li>
                                                        <button type="button" style="border: none;"
                                                            onclick="ketnoiapi('{{ $tt->matt }}','dmgiahhdvk', '{{ $inputs['url'] . '/xetduyet/' }}')"
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/csdlquocgia/qg_giahhdvk/capnhatdanhmuc', 'method' => 'post', 'id' => 'frm_update']) !!}

                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Nhóm danh mục</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <input name="matt" type="hidden" class="form-control">
                    </div>
                </div>
