...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(mahs) {
            ...
            $.ajax({
                url: '/csdlquocgia/qg_kkgiadvch/show_hoso',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
...
@section('content')
    <h3 class="page-title">
        Truyền hồ sơ kê khai Giá dịch vụ ca huế
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group btn-group-solid">
                                            ...
                                            <ul class="dropdown-menu" style="position: static">
                                                <li>
                                                    <a href="{{ url('/KetNoiAPI/HoSo?maso=kkgiadvch') }}"
                                                ...
                                                <li>
                                                    <button type="button" style="border: none;"
                                                        onclick="ketnoiapi('{{ $tt->mahs }}','kkgiadvch', '{{ $inputs['url'] . '/xetduyet/' }}')"
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/csdlquocgia/qg_kkgiadvch/capnhathoso', 'method' => 'post', 'id' => 'frm_update']) !!}
