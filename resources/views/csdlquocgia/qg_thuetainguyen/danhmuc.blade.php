...
@section('content')
    <h3 class="page-title">
        Danh mục thuế tài nguyên</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_4">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center">Tên thông tư, quyết định</th>
                                            ...
                                            <ul class="dropdown-menu" style="position: static">
                                                ...
                                                <li>
                                                    <button type="button" style="border: none;"
                                                        onclick="ketnoiapi('{{ $tt->manhom }}','dmgiathuetn', '/csdlquocgia/qg_thuetainguyen/danhmuc')"
