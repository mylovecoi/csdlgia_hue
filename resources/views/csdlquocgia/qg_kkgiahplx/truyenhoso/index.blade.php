...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(mahs) {
            ...
            $.ajax({
                url: '/csdlquocgia/qg_kkgiahplx/show_hoso',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
...
@section('content')
    <h3 class="page-title">
        Truyền hồ sơ kê khai Giá học phí lái xe
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-12">
                                            ...
                                            <ul class="dropdown-menu" style="position: static">
                                                ...
                                                <li>
                                                    <button type="button" style="border: none;"
                                                        onclick="ketnoiapi('{{ $tt->mahs }}','kkgiahplx', '{{ $inputs['url'] . '/xetduyet/' }}')"
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/csdlquocgia/qg_kkgiahplx/capnhathoso', 'method' => 'post', 'id' => 'frm_update']) !!}
