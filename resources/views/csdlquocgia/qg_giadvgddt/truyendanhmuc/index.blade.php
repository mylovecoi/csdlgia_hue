...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(maspdv) {
            ...
            $.ajax({
                url: '/csdlquocgia/qg_giadvgddt/show_nhomdm',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    maspdv: maspdv
...
@section('content')
    <h3 class="page-title">
        Truyền danh mục Giá dịch vụ Giáo dục Mầm non và Giáo dục phổ thông công lập
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group btn-group-solid">
                                            ...
                                            <ul class="dropdown-menu" style="position: static">
                                                <li>
                                                    <a href="{{ url('/KetNoiAPI/HoSo?maso=dmgiadvgddt') }}"
                                                        style="border: none;" target="_blank"
                                                        class="btn btn-default">
                                                        <i class="fa fa-caret-right"></i> Thiết lập thông điệp</a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('/KetNoiAPI/XemHoSo?maso=dmgiadvgddt&mahs=' . $tt->maspdv) }}"
                                                        style="border: none;" target="_blank"
                                                        class="btn btn-default">
                                                ...
                                                <li>
                                                    <button type="button" style="border: none;"
                                                        onclick="ketnoiapi('{{ $tt->maspdv }}','dmgiadvgddt', '{{ $inputs['url'] . '/xetduyet/' }}')"
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/csdlquocgia/qg_giadvgddt/capnhatdanhmuc', 'method' => 'post', 'id' => 'frm_update']) !!}
