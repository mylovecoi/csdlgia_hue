...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(mahs) {
            ...
            $.ajax({
                url: '/csdlquocgia/qg_giaphilephi/show_hoso',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
...
@section('content')
    <h3 class="page-title">
        Truyền hồ sơ kê khai Giá lệ phí trước bạ
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/csdlquocgia/qg_giaphilephi/capnhathoso', 'method' => 'post', 'id' => 'frm_update']) !!}
