...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(manhom) {
            ...
            $.ajax({
                url: '/csdlquocgia/qg_giaphilephi/show_nhomdm',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    manhom: manhom
...
@section('content')
    <h3 class="page-title">
        Truyền danh mục Giá lệ phí trước bạ
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <tbody>
                            @foreach ($model as $key => $tt)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <button type="button" onclick="ClickEdit('{{ $tt->manhom }}')"
                                        ...
                                        <div class="btn-group btn-group-solid">
                                            ...
                                            <ul class="dropdown-menu" style="position: static">
                                                <li>
                                                    <a href="{{ url('/KetNoiAPI/HoSo?maso=dmgiaphilephi') }}"
                                                        style="border: none;" target="_blank"
                                                        class="btn btn-default">
                                                        <i class="fa fa-caret-right"></i> Thiết lập thông điệp</a>
                                                </li>
                                                <li>
                                                    <a href="{{ url('/KetNoiAPI/XemHoSo?maso=dmgiaphilephi&mahs=' . $tt->manhom) }}"
                                                        style="border: none;" target="_blank"
                                                        class="btn btn-default">
                                                ...
                                                <li>
                                                    <button type="button" style="border: none;"
                                                        onclick="ketnoiapi('{{ $tt->manhom }}','dmgiaphilephi', '{{ $inputs['url'] . '/xetduyet/' }}')"
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/csdlquocgia/qg_giaphilephi/capnhatdanhmuc', 'method' => 'post', 'id' => 'frm_update']) !!}

                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Nhóm lệ phí trước bạ</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <input name="manhom" type="hidden" class="form-control">
                    </div>
                </div>
