...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(mahs) {
            ...
            $.ajax({
                url: '/csdlquocgia/qg_thamdinhgia/show_hoso',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    mahs: mahs
                                            ...
                                            <ul class="dropdown-menu" style="position: static">
                                                ...
                                                <li>
                                                    <button type="button" style="border: none;"
                                                        onclick="ketnoiapi('{{ $tt->mahs }}','thamdinhgia', '{{ $inputs['url'] . '/xetduyet/' }}')"
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/csdlquocgia/qg_thamdinhgia/capnhathoso', 'method' => 'post', 'id' => 'frm_update']) !!}
