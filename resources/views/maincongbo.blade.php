...
<head>
    ...
    <link href="{{ url('assets/admin/layout3/css/themes/default.css') }}" rel="stylesheet" type="text/css"
        id="style_color">
    ...
    <!-- BEGIN JavaScript ESAPI -->
    <script src="{{ url('js/maincongbo.js') }}" type="text/javascript"></script>
...
<div class="page-prefooter">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 footer-block" style="text-align: center">
