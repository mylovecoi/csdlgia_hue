                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="phanloai" id="phanloai">
                                                <option value="all" {{ $inputs['phanloai'] == 'all' ? 'selected' : '' }}>
                                                    --Tất cả--</option>
                                                <option value="gia" {{ $inputs['phanloai'] == 'gia' ? 'selected' : '' }}>
                                                    Văn bản về Giá</option>
                                                <option
                                                    value="philephi"{{ $inputs['phanloai'] == 'philephi' ? 'selected' : '' }}>
                                                    Văn bản Phí lệ phí</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
