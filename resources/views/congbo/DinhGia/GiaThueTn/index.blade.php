    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#manhom').change(function() {
                var manhom = '&manhom=' + escapeHtml($('#manhom').val());
                            ...
                            <div class="portlet light" style="min-height: 587px">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject theme-font bold uppercase"> Thông tin giá thuế tài
                                            nguyên</span>
                                    </div>
                                    <div class="tools">
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="manhom" id="manhom" class="form-control">
                                                ...
                                                @foreach ($modeldm as $dm)
                                                    <option value="{{ $dm->manhom }}"
                                                        {{ $dm->manhom == $inputs['manhom'] ? 'selected' : '' }}>
                                                        {{ $dm->tennhom }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($model as $key => $tt)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('cbgiathuetainguyen/' . $tt->id) }}"
                                                            class="btn btn-default btn-xs mbs" target="_blank"><i
