...
@section('content-cb')
    <div class=" col-sm-12">
        <h3 class="page-title">
            Thông tin giá hàng hóa dịch vụ khác
        </h3>
                ...
                <table id="sample_4" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center">Nguồn tt</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($model as $key => $tt)
                            <tr>
                                <td style="text-align: center">{{ $i++ }}</td>
                                <td><b>{{ getDayVn($tt->thoidiem) }}</b></td>
                                <td class="active" style="font-weight: bold">{{$tt->mahhdv}}</td>
                                <td style="text-align: left">{{$tt->nguontt}}</td>
                                <td style="text-align: center">{{ dinhdangsothapphan($tt->gialk, 2) }}</td>
                                <td style="text-align: center">{{ dinhdangsothapphan($tt->gia, 2) }}</td>
                                <td style="text-align: left">{{$tt->loaigia}}</td>
                            </tr>
                        @endforeach
