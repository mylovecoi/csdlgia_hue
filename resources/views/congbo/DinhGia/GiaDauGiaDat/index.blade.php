                ...
                <div class="portlet box">
                    <div class="portlet-title">
                        <div class="caption text-uppercase">
                            <span class="caption-subject theme-font bold uppercase">{{session('congbo')['chucnang']['giadaugiadat'] ?? 'Giá đấu giá đất'}}</span>
                        </div>
                    </div>
                        ...
                        <table id="sample_4" class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($model_dk as $key=>$tt)
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <button type="button" onclick="get_attack('{{$tt->mahs}}','/giadaugiadat')" class="btn btn-default btn-xs mbs" data-target="#dinhkem-modal-confirm" data-toggle="modal">
