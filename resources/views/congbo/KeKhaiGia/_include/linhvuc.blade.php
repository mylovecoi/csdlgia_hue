    ...
    <script>
        ...
        $(function(){
            $('.changeval').change(function() {
                var url = '/cblinhvuckk?phanloai='+ $('#phanloai').val() + '&madiaban=' + $('#madiaban').val() + '&madv=' + $('#madv').val() ;
                        ...
                        <div class="portlet light" style="min-height: 587px">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="theme-font bold uppercase">Thông tin công bố giá theo lĩnh vực hoạt động kinh doanh</span>
                                </div>
                                <div class="tools">
                                </div>
                            </div>
