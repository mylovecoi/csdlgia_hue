    ...
    <script>
        ...
        $(function(){
            $('.changeval').change(function() {
                var url = '/cbkekhaigia?madiaban=' + $('#madiaban').val()+ '&madv=' + $('#madv').val() + '&phanloai=' + $('#phanloai').val();
                        ...
                        <div class="portlet light" style="min-height: 587px">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="theme-font bold uppercase">Thông tin công bố giá theo doanh nghiệp kê khai, niêm yết</span>
                                </div>
                                <div class="tools">
                                </div>
                            </div>
