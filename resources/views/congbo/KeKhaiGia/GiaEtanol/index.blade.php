...
@section('custom-script-cb')
    ...
    <script>
        ...
        $('#tthhdv, #nam').change(function() {
            var namhs = '&nam=' + escapeHtml($('#nam').val());
            var tthhdv = '&tthhdv=' + escapeHtml($('#tthhdv').val());
                ...
                <div class="portlet-title">
                    <div class="row">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject theme-font bold uppercase">Etanol nhiên liệu không biến tính, khí
                                tự nhiên hóa lỏng(LNG); khí thiên nhiên nén (CNG)</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tthhdv" name="tthhdv"
                                    value="{{ $inputs['tthhdv'] }}">
                            </div>
                        </div>
                    </div>
