    ...
    <script>
        ...
        $(function() {
            $('#level').change(function() {
                var level = '&level=' + escapeHtml($('#level').val());
                var url = '/danhsachusertaphuan?' + level;
                window.location.href = validURL(url);
            });
        });
    </script>
@stop
                            ...
                            <div class="portlet light" style="min-height: 587px">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject theme-font bold uppercase">Danh sách tài khoản tập
                                            huấn</span>
                                    </div>
                                    <div class="tools">
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($model as $key => $tt)
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="{{ url('login?&username=' . $tt->username) }}"
                                                            class="btn btn-default btn-xs mbs"><i
                                                                class="fa fa-edit"></i>&nbsp;Login</a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
