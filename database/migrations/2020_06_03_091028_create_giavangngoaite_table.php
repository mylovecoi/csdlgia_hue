...
class CreateGiavangngoaiteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('giavangngoaite');
    }
}
