...
class qg_thamdinhgiaController extends Controller
{
    // public function nhandanhmuc(Request $request){
    //     $model = giaspdvcidm::all();
    //     $inputs['url'] = '/csdlquocgia/qg_thamdinhgia/nhandanhmuc';
    //     return view('csdlquocgia.qg_thamdinhgia.nhandanhmuc.index')
    //         ->with('model',$model)
    //         ->with('inputs',$inputs)
    //         ->with('pageTitle','Danh mục Thẩm định giá');
    // }
    ...
    public function nhanhoso(Request $request)
    {
        if (Session::has('admin')) {
            $inputs = $request->all();
            $inputs['url'] = '/csdlquocgia/qg_thamdinhgia/nhanhoso';
            ...
            return view('csdlquocgia.qg_thamdinhgia.nhanhoso.index')
                ...
                ->with('pageTitle','Nhận hồ sơ thẩm định giá');   
        } else
    ...
    public function chuyenhs(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $model->save();
            return redirect('/csdlquocgia/qg_thamdinhgia/nhanhoso?madv=' . $model->madv);
        } else
            return view('errors.notlogin');
    }
    ...
    // {
    //     $model = giaspdvcidm::all();
    //     $inputs['url'] = '/csdlquocgia/qg_thamdinhgia/danhmuc';
    //     $inputs['truyendulieu'] = $inputs['truyendulieu'] ?? 'all';
    //     if ($inputs['truyendulieu'] != 'all')
    //         $model = $model->where('truyendulieu', $inputs['truyendulieu']);
    //     return view('csdlquocgia.qg_thamdinhgia.truyendanhmuc.index')
    //         ->with('model',$model)
    //         ->with('inputs',$inputs)
    //         ->with('pageTitle','Truyền danh mục Thẩm định giá');
    // }
    ...
    //     $model->update($inputs);
    //     return redirect('/csdlquocgia/qg_thamdinhgia/danhmuc?truyendulieu=' . $inputs['truyendulieu']);
    // }
    ...
    {
        $inputs = $request->all();
        $inputs['url'] = '/csdlquocgia/qg_thamdinhgia/hoso';
        $a_diaban = getDiaBan_Level(\session('admin')->level, \session('admin')->madiaban);
        $m_diaban = dsdiaban::wherein('madiaban', array_keys($a_diaban))->get();
        ...
        return view('csdlquocgia.qg_thamdinhgia.truyenhoso.index')
            ->with('model', $model)
            ->with('inputs', $inputs)
            ->with('m_diaban', $m_diaban)
            ...
            ->with('a_donvi_th',array_column($m_donvi_th->toarray(),'tendv','madv'))
            ->with('a_diaban_th',array_column($m_donvi_th->toarray(),'tendiaban','madiaban'))
            ->with('pageTitle', 'Truyền hồ sơ Thẩm định giá');
    }
    ...
    public function capnhathoso(Request $request)
    {
        ...
        $model = ThamDinhGia::where('mahs',$inputs['mahs'])->first();
        $model->update($inputs);
        return redirect('/csdlquocgia/qg_thamdinhgia/hoso?truyendulieu=' . $inputs['truyendulieu']);
    }
    ...
    //     $inputs = $request->all();
    //     $inputs['truyendulieu'] = $inputs['truyendulieu'] ?? 'all';
    //     $inputs['url'] = '/csdlquocgia/qg_thamdinhgia/congbo_danhmuc';
    //     $model = giaspdvcidm::all();
    //     if ($inputs['truyendulieu'] != 'all')
    //         $model = $model->where('truyendulieu', $inputs['truyendulieu']);
    //     return view('csdlquocgia.qg_thamdinhgia.truyendanhmuc.congbo')
    //         ->with('model', $model)
    //         ->with('inputs', $inputs)
    //         ->with('pageTitle', 'Công bố danh mục Thẩm định giá');
    // }

    public function congbo_hoso(Request $request)
    {
        $inputs = $request->all();
        $inputs['url'] = '/csdlquocgia/qg_thamdinhgia/congbo_hoso';
        ...
        return view('csdlquocgia.qg_thamdinhgia.truyenhoso.congbo')
            ->with('model', $model->get())
            ->with('inputs', $inputs)
            ->with('m_donvi', $m_donvi)
            ->with('pageTitle', 'Công bố hồ sơ Thẩm định giá');
    }
}
