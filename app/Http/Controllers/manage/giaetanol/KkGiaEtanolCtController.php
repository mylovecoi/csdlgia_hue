...
class KkGiaEtanolCtController extends Controller
{
    public function store(Request $request){
        ...
        if($model != null){
            ...
            KkGiaEtanolCt::create($inputs);
        }

        $model = KkGiaEtanolCt::where('mahs', $inputs['mahs'])->get();
    ...
    public function destroy(Request $request){
        ...
        $inputs = $request->all();
        if(isset($inputs['id'])){
            KkGiaEtanolCt::where('id',$inputs['id'])->delete();
            $model = KkGiaEtanolCt::where('mahs',$inputs['mahs'])->get();
    ...
    public function updatenhapkhau(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $modelup = KkGiaEtanolCt::where('id',$inputs['id'])->first()->update($inputs);
