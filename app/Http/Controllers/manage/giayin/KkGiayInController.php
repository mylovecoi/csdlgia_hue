...
class KkGiayInController extends Controller
{
...
//            dd($m_lvkd);
            ...
            return view('manage.giayin.kekhai.index')
    ...
    public function create(Request $request){
        if (Session::has('admin')) {
            ...
            $inputs['url'] = '/giayin';
            return view('manage.giayin.kekhai.create')
                ->with('model', $model)
    ...
    public function store(Request $request){
        if (Session::has('admin')) {
            ...
            return redirect('giayin/danhsach?madv='.$inputs['madv']);
    ...
    public function show(Request $request){
        if (Session::has('admin')) {
            ...
            return view('manage.giayin.baocao.print')
    ...
    public function destroy(Request $request){
        if (Session::has('admin')) {
            ...
            return redirect('giayin/danhsach?madv='.$model->madv);
        }else
            return view('errors.notlogin');
    }
    ...
    public function timkiem(){
        if (Session::has('admin')) {
            ...
            //dd($m_bog);
            return view('manage.giayin.timkiem.index')
                ->with('inputs', $inputs)
                ->with('m_diaban', $m_diaban)
                ->with('a_dm', array_column($m_dm->toarray(),'tennghe','manghe'))
                ->with('m_donvi', $m_donvi)
                ->with('a_phanloai',  array('DK'=>'Đăng ký giá','KK'=>'Kê khai giá'))
                ->with('pageTitle', 'Tìm kiếm hồ sơ giá kê khai giá giấy');
    ...
    public function ketquatk(Request $request){
        if (Session::has('admin')) {
            ...
            return view('manage.giayin.timkiem.result')
