...
class KkGiaThanXdController extends Controller
{
    ...
    public function xetduyet(Request $request)
    {
        if (Session::has('admin')) {
            ...
            return view('manage.giathan.xetduyet.index')
                ->with('model', $model)
                ->with('inputs', $inputs)
                ...
                ->with('pageTitle', 'Thông tin hồ sơ kê khai giá than');
        } else
            return view('errors.notlogin');
    }
    ...
    public function duyeths(Request $request)
    {
        if (Session::has('admin')) {
            ...
            return redirect('giathan/xetduyet?madv=' . $inputs['madv']);
        } else
            return view('errors.notlogin');
    }
    ...
    public function congbo(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $model->save();
            return redirect('giathan/xetduyet?madv=' . $model->madv_ad);
        } else
            return view('errors.notlogin');
    }
    //</editor-fold>
