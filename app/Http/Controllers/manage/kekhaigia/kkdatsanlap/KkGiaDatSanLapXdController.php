...
class KkGiaDatSanLapXdController extends Controller
{
    public function index(Request $request)
    {
        if (Session::has('admin')) {
            $inputs = $request->all();
            $inputs['url'] = '/xetduyetkkgiadatsanlap';
            //lấy địa bàn
            ...
            switch ($inputs['level']) {
                case 'H': {
                        $model = KkGiaDatSanLap::where('madv_h', $inputs['madv']);
                        if ($inputs['nam'] != 'all')
                ...
                case 'T': {
                        $model = KkGiaDatSanLap::where('madv_t', $inputs['madv']);
                        if ($inputs['nam'] != 'all')
                ...
                case 'ADMIN': {
                        $model = KkGiaDatSanLap::where('madv_ad', $inputs['madv']);
                        if ($inputs['nam'] != 'all')
            ...
            return view('manage.kkgia.datsanlap.kkgia.xetduyet.index')
                ->with('model', $model)
                ->with('inputs', $inputs)
                ...
                ->with('pageTitle', 'Xét duyệt hồ sơ kê khai giá đất san lấp');
        } else
            return view('errors.notlogin');
    }

    public function ttdnkkdatsanlap(Request $request)
    {
        $result = array(
            'status' => 'fail',
            'message' => 'error',
        ...
        if (isset($inputs['id'])) {
            ...
            $modelhs = KkGiaDatSanLap::where('id', $inputs['id'])->first();
    ...
    public function tralai(Request $request)
    {
        if (Session::has('admin')) {
            ...
            /*dd($inputs);*/
            $inputs['macqcq'] = 'BTL';
            $model = KkGiaDatSanLap::where('id', $inputs['idtralai'])->first();
            ...
            return redirect('xetduyetkkgiadatsanlap?madv=' . $inputs['madvtralai']);
        } else
            return view('errors.notlogin');
    }
    ...
    public function ttnhanhs(Request $request)
    {
        ...
        $inputs = $request->all();
        $modelhs = KkGiaDatSanLap::where('mahs', $inputs['mahs'])->first();
        $modeldn = Company::where('madv', $modelhs->madv)->first();
    ...
    {
        $idmax = KkGiaDatSanLap::wherein('trangthai', ['DD', 'CB', 'HCB'])
            ->max('id');
        if (isset($idmax)) {
            $model = KkGiaDatSanLap::where('id', $idmax)->first();
    ...
    public function nhanhs(Request $request)
    {
        if (Session::has('admin')) {
            ...
            return redirect('xetduyetkkgiadatsanlap?madv=' . $model->macqcq);
        } else
            return view('errors.notlogin');
    }
    ...
    public function congbo(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $model->save();
            return redirect('xetduyetkkgiadatsanlap?madv=' . $model->madv_ad);
        } else
            return view('errors.notlogin');
    }
    ...
    public function search(Request $request)
    {
        if (Session::has('admin')) {
            ...
            if ($inputs['nam'] != 'all')
                $model = $model->whereYear('kkgiadatsanlap.ngayhieuluc', $inputs['nam']);
            $model = $model->get();
            /*dd($model);*/
            return view('manage.kkgia.datsanlap.kkgia.timkiem.index')
                ->with('model', $model)
                ->with('inputs', $inputs)
                ->with('pageTitle', 'Tìm kiếm thông tin kê khai giá đất san lấp');
        } else
            return view('errors.notlogin');
    }
    ...
    public function printf(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $model = $model->get();
            /*dd($model);*/
            return view('manage.kkgia.datsanlap.kkgia.timkiem.printf')
                ->with('model', $model)
                ->with('inputs', $inputs)
                ->with('pageTitle', 'Tìm kiếm thông tin kê khai giá đất san lấp');
        } else
