...
class KkGiaTaCnXdController extends Controller
{
    public function index(Request $request)
    {
        if (Session::has('admin')) {
            ...
            switch ($inputs['level']){
                case 'H':{
                    $model = KkGiaTaCn::where('madv_h', $inputs['madv']);
                    if ($inputs['nam'] != 'all')
                ...
                case 'T':{
                    $model = KkGiaTaCn::where('madv_t', $inputs['madv']);
                    if ($inputs['nam'] != 'all')
                ...
                case 'ADMIN':{
                    $model = KkGiaTaCn::where('madv_ad', $inputs['madv']);
                    if ($inputs['nam'] != 'all')
            ...
            /*dd($model);*/
            return view('manage.kkgia.tacn.kkgia.xetduyet.index')
                ->with('model', $model)
                ->with('inputs', $inputs)
                ...
                ->with('pageTitle', 'Xét duyệt hồ sơ kê khai giá thức ăn chăn nuôi');
        } else
    ...
    public function ttdnkktacn(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $modelhs = KkGiaTaCn::where('id',$inputs['id'])->first();
    ...
    public function tralai(Request $request){
        if (Session::has('admin')) {
            ...
            return redirect('xetduyetgiatacn?madv=' . $inputs['madvtralai']);
    ...
    public function ttnhanhs(Request $request)
    {
        ...
        $inputs = $request->all();
        $modelhs = KkGiaTaCn::where('mahs', $inputs['mahs'])->first();
        $modeldn = Company::where('madv', $modelhs->madv)->first();
    ...
    public function getsohsnhan($macqcq){
        $idmax = KkGiaTaCn::wherein('trangthai', ['DD', 'CB', 'HCB'])
            ->max('id');
        if (isset($idmax)) {
            $model = KkGiaTaCn::where('id',$idmax)->first();
    ...
    public function nhanhs(Request $request){
        if (Session::has('admin')) {
            ...
            return redirect('xetduyetgiatacn?madv='.$model->macqcq);
        }else
            return view('errors.notlogin');
    }
    ...
    public function congbo(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $model->save();
            return redirect('xetduyetgiatacn?madv=' . $model->madv_ad);
        } else
            return view('errors.notlogin');
    }
    ...
    public function search(Request $request){
        if (Session::has('admin')) {
            ...
            $model = $model->get();
            /*dd($model);*/
            return view('manage.kkgia.tacn.kkgia.timkiem.index')
                ->with('model',$model)
                ->with('inputs',$inputs)
