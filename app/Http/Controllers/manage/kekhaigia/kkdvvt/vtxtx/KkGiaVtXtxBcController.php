...
class KkGiaVtXtxBcController extends Controller
{
    public function index(){
        if (Session::has('admin')) {
            ...
            return view('manage.kkgia.vtxtx.reports.index')
                ...
                ->with('pageTitle', 'Báo cáo tổng hợp kê khai cước vận tải hành khách bằng xe taxi tuyến cố định');
        }else
    ...
    public function bc1(Request $request){
        if (Session::has('admin')) {
            $inputs = $request->all();
            $model =  KkGiaVtXtx::join('company','company.madv','=','kkgiavtxtx.madv')
    ...
    public function bc2(Request $request){
        if (Session::has('admin')) {
            ...
            $modelct = KkGiaVtXtxCt::whereIn('mahs',explode(',',$mahss))->get();
