...
class KkGiaVtXtxCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['mota'])){
            $modelkkgia = new KkGiaVtXtxCtDf();
            $modelkkgia->create($inputs);
            $model = KkGiaVtXtxCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function update(Request $request){
        ...
        $inputs = $request->all();
        if(isset($inputs['id'])){
            $modelkkgia = KkGiaVtXtxCtDf::where('id',$inputs['id'])->first();
    ...
    public function kkgialk(Request $request){
        ...
        $inputs = $request->all();
        if(isset($inputs['id'])){
            $model = KkGiaVtXtxCtDf::where('id',$inputs['id'])
                ->first();
