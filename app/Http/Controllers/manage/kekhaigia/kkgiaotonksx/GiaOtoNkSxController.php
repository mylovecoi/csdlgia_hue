...
class GiaOtoNkSxController extends Controller
{
    public function index(Request $request){
        if (Session::has('admin')) {
            ...
            $model = GiaOtoNkSx::where('madv', $inputs['madv'])
    ...
    public function create(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $modellk = GiaOtoNkSx::where('madv', $inputs['madv'])
                ->where('trangthai', 'DD')
                ->orderby('ngayhieuluc', 'desc')->first();

            if ($modellk != null) {
                $modellkct = GiaOtoNkSxCt::where('mahs', $modellk->mahs)->get();
