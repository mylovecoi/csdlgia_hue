...
class GiaXeMayNkSxController extends Controller
{
    public function index(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $model = GiaXeMayNkSx::where('madv', $inputs['madv'])
    ...
    public function create(Request $request)
    {
        if (Session::has('admin')) {
            ...
            $modellk = GiaXeMayNkSx::where('madv', $inputs['madv'])
                ->wherein('trangthai', ['DD', 'CB', 'HCB'])
                ->orderby('ngayhieuluc', 'desc')->first();

            if ($modellk != null) {
                $modellkct = GiaXeMayNkSxCt::where('mahs', $modellk->mahs)->get();
